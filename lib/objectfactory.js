...
var decorated = function(target, source, k, data, path) {
	...
	callHooks("onChange", [{target:target, key:k, path:path+k, args:data.a, modules:data.m}], data);
};
////////////////////////////////////////////////////////////////////////////////
...
factory.extend = function(){
	...
	var Executable = function Executable(module, data){
		...
		thisData.d && callHooks("onConstruct", [{args:thisData.a, modules:thisData.m}], thisData);
